...
myStartupHook = do
    ...
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent false --alpha 0 --tint 0x282c34  --height 22 &"
...
myShowWNameTheme = def
    { swn_font              = "xft:FiraMono Nerd Font:bold:size=60"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#1c1f24"
    , swn_color             = "#ffffff"
    }
...
myWorkspaces = [" main ", " www ", " email ", "messaging", " os ", " code ", " extra "]
...
myKeys =
    ...
    -- Run Prompt
        ...
        , ("M-S-<Return>", spawn "rofi -combi-modi window,ssh,drun -show combi") -- Rofi
